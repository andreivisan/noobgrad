...
class DenseLayer:
    def __init__(self, n_inputs, n_neurons):
        ...
        '''
        # we have n_inputs and n_neurons for weights instead of reverse to not transpose everytime
        self.weights = np.random.randn(n_inputs, n_neurons) * np.sqrt(2.0 / n_neurons)
